...
public class CreateTestAndTrainData {

	private CreateTestAndTrainData() {}
	...
	public static void main(String[] args) throws Exception {
		...
		int diffrentSymbolCount = symbols.size()+1;
		
		int syId = 0;
		for(String symbol:symbols) {
			double[] oneHotCode = new double[diffrentSymbolCount];
			oneHotCode[syId] = 1.0;
		...
		File outputFile = new File(outputFolder, ADatasetCreator.createCSVFileName("training_data_v2", pointPerGesture*gestureInputCount+1, classToSampleOutput.size()));
		...
		//Storing created data set
		outputFile = new File(outputFolder, ADatasetCreator.createCSVFileName("test_data_v2", pointPerGesture*gestureInputCount+1, classToSampleOutput.size()));
