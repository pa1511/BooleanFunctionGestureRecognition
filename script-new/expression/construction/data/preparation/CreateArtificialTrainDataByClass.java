...
public class CreateArtificialTrainDataByClass {

	private CreateArtificialTrainDataByClass() {}
	...
	public static void main(String[] args) throws Exception {
		...
		File outputFile = new File(outputFolder, ADatasetCreator.createCSVFileName("artificial_training_data", dataSet.getSampleSize(0), differentOutputCount));
