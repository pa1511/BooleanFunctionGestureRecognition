...
public class LexicalToken {
	...
	public static enum Type{
		...
		static{
			...
			TRUE.nextPossibleTypes = new Type[]{AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE,EQUALS};
			FALSE.nextPossibleTypes = new Type[]{AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE,EQUALS};
			FUNCTION.nextPossibleTypes = new Type[]{EQUALS,AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE,VARIABLE,TRUE,FALSE};
			VARIABLE.nextPossibleTypes = new Type[]{AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE,EQUALS,VARIABLE};
			...
			RIGHT_BRACKET.nextPossibleTypes = new Type[]{AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE};
			//
			...
			RIGHT_BRACKET_NOT_VISIBLE.nextPossibleTypes = new Type[]{AND,OR,RIGHT_BRACKET,RIGHT_BRACKET_NOT_VISIBLE};
		}
